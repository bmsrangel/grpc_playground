...
import 'hello_world.pb.dart' as $2;
...
class GreeterClient extends $grpc.Client {
  ...
  static final _$sayHelloAgain =
      $grpc.ClientMethod<$2.HelloRequest, $2.HelloReply>(
  ...
  $grpc.ResponseFuture<$2.HelloReply> sayHelloAgain($2.HelloRequest request,
      {$grpc.CallOptions? options}) {
...
abstract class GreeterServiceBase extends $grpc.Service {
  ...
  $async.Future<$2.HelloReply> sayHelloAgain_Pre(
      $grpc.ServiceCall call, $async.Future<$2.HelloRequest> request) async {
  ...
  $async.Future<$2.HelloReply> sayHelloAgain(
      $grpc.ServiceCall call, $2.HelloRequest request);
}
